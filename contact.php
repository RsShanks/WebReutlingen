...
if ($_POST['envoyer']=="Envoyer") {
    ...
    if ($nbr_erreur == 0) {
        ...
        try {
            ...
            $mail->MsgHTML('<h2>Bonjour Webmaster,</h2><br><br> Un nouveau client vous a envoyé un message :<br>Nom du client : ' . $nom . ' ' . $prenom . '<br>Contenu : ' . $contenu . '<br><br>Passez une agréable journée jeune maitre.'); 		                //Le contenu au format HTML
