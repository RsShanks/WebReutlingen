    ...
    ?>
                    <section class="resume_produit">
                        ...
                        <div class="image-wrap">
                            ...
                            <div class="contour">
                                <div class="image" style="background-image:url('<?php echo $produit['img']?>')">
                                </div>
                            </div>
                            ...
                            <div class="description">
                                ...
                                if ($_SESSION['connecte'] == 2) {
                                    echo "<br>";
                                    echo  "<button class='display_stock' id='stock' onclick='affiche_stock(" . $produit['stock'] . ")' value='mode1'>Appuyer pour afficher le stock</button>";
                                ...
                                <div class="ref_produit">
                                    <p>Référence du produit : <?php echo $produit['code'] ?></p>
                                </div>
